...
int						thread_handler(pthread_t *thread,
							void *(*routine)(void *), void *arg, t_thread code);
...
void					set_value_int(pthread_mutex_t *mutex, int value,
							int *dest);
long					get_value_long(pthread_mutex_t *mutex, long *value);
void					set_value_long(pthread_mutex_t *mutex, long value,
							long *dest);
...
// status
void					print_status(t_table *table, t_philo *philo,
							t_status code);
